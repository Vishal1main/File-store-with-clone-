...
SHORTLINK_API = environ.get("SHORTLINK_API", "8e869e3bd0f04a3dd1282d4e0a7bb52224a3a576") # shortlink api
SHORTLINK_URL = environ.get("SHORTLINK_URL", "Ziplinker.net") # shortlink domain without https://
